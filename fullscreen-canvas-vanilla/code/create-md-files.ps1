...
# Hardcoded paths
$dataFile = "C:\Atari-Monk-Art\prompting\fullscreen-canvas-vanilla\code\file-list.md"
$targetDir = "C:\Atari-Monk-Art\prompting\fullscreen-canvas-vanilla\code\payload"
